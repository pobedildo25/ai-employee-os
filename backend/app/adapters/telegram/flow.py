...
class TelegramProductFlow:
    ...
    async def handle_message(self, request: TelegramExecutionRequest) -> dict[str, Any]:
        ...
        if convo.flow_mode == TelegramFlowMode.COMPLETED:
    ...
    @staticmethod
    def _enrich_prior_state_for_revision(convo: TelegramConversationState) -> dict[str, Any]:
    ...
    async def _set_active_artifact(self, convo: TelegramConversationState, artifact_id: str | None) -> None:
